...
<template>
    <br>
    <!-- <button type="button" id="btn_addAuthor" class="btn btn-success" @click="addBookType()" style="position: relative; left: 22%;"><i class="fa-solid fa-plus"></i> Thêm Thể Loại </button> -->


    <form action="/" class="d-flex" style="width:500px;margin:0 auto" id="inputSearchKeyWord" @submit.prevent>
        <input type="text" class="form-control" placeholder="Nhập vào tên thể loại..." aria-label="Recipient's username" aria-describedby="basic-addon2" style="border-radius:6px; font-size: 15px; position: absolute; top: 40%; width: 30%;" v-model="inputSearch">
