...
<template>
    ...
    <br>
    <div class="container">
            <div class="row contentdk">
                
                <!-- Ảnh bển trái -->

                <div class="col-md-6 mb-3">
                    <img src="/src/assets/images/dk1.png" class="img-fluid" alt="">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <h1 class="signin-text mb-3">ĐĂNG KÝ TÀI KHOẢN</h1>

                    <!-- form -->

                    <Form :validation-schema="Registerform" @submit.prevent class="form-box px-3" style="font-size: 15px">
                        <!-- UserName Input -->
                        <div class="mb-3">
                        ...
                        <div class="text-center mb-2" style="font-size: 18px;"><br>Bạn đã có tài khoản?
                            <router-link to="/login" class="register-link">Đăng Nhập
                            </router-link>
                        </div>
